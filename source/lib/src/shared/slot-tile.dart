...
class SlotTile extends StatelessWidget {
  ...
  String _nextAvailableslot = "-";
  int _noOfSlots = 0;
  final Future<void> Function(int centreId, bool isSubscribe) callBack;

  SlotTile(this._vaccineCentre, this._vaccineTypes, this.ageFilter,
      {this.callBack});
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: [
                            InkWell(child: Text(
                              _vaccineCentre.name, style: TextStyle(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Icon(Icons.location_pin, color: Colors.grey,
                                        size: 14.0),
                                    Flexible(
                                        child: Text(_vaccineCentre.address ??
                                            _vaccineCentre.block_name,
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                                border: Border(top: BorderSide(color: Color
                                    .fromRGBO(171, 187, 191, 1), width: 1))),
                            child: Row(
                                ...
                                children: [
                                  Text(
                                      _vaccineCentre.fee_type, style: TextStyle(
                                      fontSize: 13.0, color: Colors.orange)),
                                  Text("Next Slot on: " +
                                      (getSlotDetails().length > 2 ? _nextAvailableslot.substring(0, 11) : "-"),
                                      style: TextStyle(
            ...
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        child: Text(_noOfSlots.toString() + ' slots',
                            style: TextStyle(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_noOfSlots > 0) {
                              ...
                              Toast.show("Unable to redirect to book", context,
                                  duration: Toast.LENGTH_SHORT,
                                  gravity: Toast.BOTTOM);
                            } else {
                              //Notify call
                              _vaccineCentre.isSubcribed =
                              !_vaccineCentre.isSubcribed;
                              await callBack(_vaccineCentre.center_id,
                                  _vaccineCentre.isSubcribed);
                            }
                          },
                          child: Text(
                              _noOfSlots > 0 ? 'Book Now' : (!_vaccineCentre
                                  .isSubcribed ? 'Notify Me' : "Unsubscribe")),
                        ))
                  ],
                )
            )
  ...
  String getSlotDetails() {
    if (ageFilter["age18"] && ageFilter["age45"] && _vaccineTypes["Dose 1"] &&
      ...
      _noOfSlots = _vaccineCentre.getSlots();
    ...
    if (ageFilter["age18"] && ageFilter["age45"] && _vaccineTypes["Dose 1"] &&
      ...
      _noOfSlots =
          _vaccineCentre.totalAvailableCapacityDose1_18 ??
    ...
    if (ageFilter["age18"] && ageFilter["age45"] && !_vaccineTypes["Dose 1"] &&
      ...
      _noOfSlots = _vaccineCentre.totalAvailableCapacityDose2_18 ??
    ...
    if (ageFilter["age18"] && !ageFilter["age45"] && _vaccineTypes["Dose 1"] &&
      ...
      _noOfSlots = _vaccineCentre.totalAvailableCapacityDose1_18 ??
    ...
    if (!ageFilter["age18"] && ageFilter["age45"] && _vaccineTypes["Dose 1"] &&
      ...
      _noOfSlots = _vaccineCentre.totalAvailableCapacityDose1_45 ??
          0 + _vaccineCentre.totalAvailableCapacityDose2_45 ?? 0;
      return _nextAvailableslot;
    }
    if (!ageFilter["age18"] && ageFilter["age45"] && !_vaccineTypes["Dose 1"] &&
      ...
      _nextAvailableslot =
          (_vaccineCentre.nextAvailableSlot45_Dose2 ?? "-").toString();
      _noOfSlots = _vaccineCentre.totalAvailableCapacityDose2_45 ?? 0;
      return _nextAvailableslot;
    }
    if (!ageFilter["age18"] && ageFilter["age45"] && _vaccineTypes["Dose 1"] &&
        !_vaccineTypes["Dose 2"]) {
      _nextAvailableslot =
          (_vaccineCentre.nextAvailableSlot45_Dose1 ?? "-").toString();
      _noOfSlots = _vaccineCentre.totalAvailableCapacityDose1_45 ?? 0;
      return _nextAvailableslot;
    }
    if (ageFilter["age18"] && !ageFilter["age45"] && !_vaccineTypes["Dose 1"] &&
        _vaccineTypes["Dose 2"]) {
      ...
      _noOfSlots = _vaccineCentre.totalAvailableCapacityDose2_18 ?? 0;
      return _nextAvailableslot;
    }
    if (ageFilter["age18"] && !ageFilter["age45"] && _vaccineTypes["Dose 1"] &&
        !_vaccineTypes["Dose 2"]) {
  ...
  List<VaccineSession> filterSessions() {
    if (!ageFilter["age18"]) {
      _vaccineCentre.sessions.removeWhere((element) =>
      element.min_age_limit == 18);
    }
    if (!ageFilter["age45"]) {
      _vaccineCentre.sessions.removeWhere((element) =>
      element.min_age_limit == 45);
    }
